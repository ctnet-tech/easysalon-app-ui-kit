    ...
    return StandardPage(
        ...
        children: [
          Container(
            child: Column(
              children: [
                dividerCustom.Divider(size: LayoutSize.small,customHeight: double.infinity,),
                NotificationTag(
                  notificationTagType: NotificationTagType.newAppointment,
                  idCustomer: "T00012",
                  idInvoice: "HD0001",
                  totalInvoice: "550,000",
                  timeNewAppointment: "09:45 30/09/2020",
                  listService: ["Cắt tóc nam", "Tiêm meso matrix"],
                  timeTitle: "15 phút trước",
                ),
                dividerCustom.Divider(size: LayoutSize.small,customHeight: double.infinity,),
                NotificationTag(
                  notificationTagType: NotificationTagType.paid,
                  title: "TN - Bảo An",
                  idCustomer: "T00012",
                  idInvoice: "HD0000058",
                  totalInvoice: "600,000",
                  timeTitle: "15 phút trước",
                  listService: ["Cắt tóc nam","Tiêm meso matrix"],
                ),
                dividerCustom.Divider(size: LayoutSize.small,customHeight: double.infinity,),
                NotificationTag(
                  title: "1 giờ nữa",
                  timeTitle: "10:45, hôm nay",
                  notificationTagType: NotificationTagType.remind,
                  idCustomer: "T00021",
                  totalInvoice: "550,000",
                  listService: ["Cắt tóc nam","Tiêm meso matrix"],
                ),
